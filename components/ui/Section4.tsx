  ...
  return (
    <Container>
        ...
        <div className="flex flex-col gap-3 items-center justify-center p-5 w-full md:w-[70%]">
          <h1 className="text-dblue text-[25px] md:text-[32px] font-bold md:font-semibold">The Core of Our Team</h1>
        ...
        <div>
          ...
          <div className="flex gap-2 flex-col">
            <img className="w-[384px] h-[300px] md:h-[370px] rounded-[2px]" src="https://s3-alpha-sig.figma.com/img/b458/ecbc/bd2cd80323072b725f36354f24c56b53?Expires=1715558400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=Pvj5Uk9t92JlLRDWTaKD0DzkIZyHRZ8Gqkf-e~s~gZbbJG3~vOvdusMtqFY~ETvi4EoZOmd7WrmrNw7UyxJSSRz3Oz5pspjsMmVd0FhqemSgKzFIHIWOGDqiokr6Js2i3hWpkCeTwoE7WLZii~hU0J18vk1uGQMHaCefdpz4VCQIZrWIaVSR7fnFH8PtQXaMI~3y5aKFxd~K11Lh6M7xFFrfFfp8XZK4EDQRB0jRZSeyRN6PPV9~JxJLMfGhffGXpEF9-0KdecLIqT-4AQAkZdVcC5foXsRYS1b4bnY9uaqUDVPEJ9i8W8RcLPG90Fy6dYcIBN5MUJcnBlHVnFf83A__" alt="img1" />
