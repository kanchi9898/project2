...
const Section5 = () => {
  ...
  <div className="flex flex-col gap-3 items-center justify-center p-5 h-full w-full md:w-[70%]">
          <h1 className="text-dblue text-[26px] md:text-[32px] font-bold md:font-semibold">Frequently asked questions</h1>
